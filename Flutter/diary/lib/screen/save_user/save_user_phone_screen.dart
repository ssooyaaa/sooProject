...
import 'package:diary/vo/user.dart' as U;
...
class SaveUserPhoneScreen extends StatefulWidget {
  const SaveUserPhoneScreen({super.key});

  @override
  State<SaveUserPhoneScreen> createState() => _SaveUserPhoneScreenState();
}

class _SaveUserPhoneScreenState extends State<SaveUserPhoneScreen> {
                                ...
                                onPressed: () async{
                                  ...
                                  if(result!=null){
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(content: Text('이미 저장되어있는 번호입니다.')),
                                    );
                                  }else{
                                    //todo SMS 인증버튼
          ...
          onPressed: () async{
            ...
            try{
              ...
              if(user != null){
                ...
                //uid & number 상태관리 세팅
                Provider.of<UserModel>(context, listen: false).setUidAndPhone(uid: uid, phoneNumber: userPhoneController.text);
